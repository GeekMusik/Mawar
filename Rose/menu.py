...
fbuttons = InlineKeyboardMarkup(
        ...
        [
            InlineKeyboardButton(
                text="👥Support Group", url="https://t.me/GeekMusik"
            ),
            InlineKeyboardButton(
                text="👤News Channel", url="https://t.me/MH_Projects"
            )
        ], 
        [
            InlineKeyboardButton(
                text="⚒ Source Code", url="https://github.com/GeekMusik/Mawar"
            ),
            InlineKeyboardButton(
                text="📓 Documentation", url="https://geekmusic.mhpay.repl.co/mawar"
            )
        ], 
        [
            InlineKeyboardButton(
                text="🖥 How To Deploy Me", url="https://geekmusic.mhpay.repl.co/mawar"
            )
        ], 
        [
